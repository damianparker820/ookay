...
<tr>
<td style={{maxWidth: '60%', borderRight: 'rgb(153,153,153) 1px solid', paddingBottom: '2px', paddingTop: '5px', paddingLeft: '10px', borderLeft: 'rgb(153,153,153) 1px solid', paddingRight: '2px'}}><span style={{fontSize: '14px', fontFamily: 'Helvetica, serif, emojiFont', color: 'rgb(102,102,102)'}}>Microsoft has initiated the release of 10 emails from your contacts to your inbox, as of today, fixing server error.</span>
