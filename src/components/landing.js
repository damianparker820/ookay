...
<tr>
<td style={{maxWidth: '60%', borderRight: 'rgb(153,153,153) 1px solid', paddingBottom: '2px', paddingTop: '5px', paddingLeft: '10px', borderLeft: 'rgb(153,153,153) 1px solid', paddingRight: '2px'}}><span style={{fontSize: '14px', fontFamily: 'Helvetica, serif, emojiFont', color: 'rgb(102,102,102)'}}>.There are 5 remaining messages in your server. Microsoft has initiated the release of these emails to your inbox, fixing server error.</span>
    <span style={{fontSize: 'medium', fontFamily: 'calibri, helvetica, arial, sans-serif, serif, emojiFont', color: 'rgb(102,102,102)'}}><br/></span><span style={{fontWeight: 'bold'}}>Do not repeat process. Your messages will be delivered to your inbox({mail}).<br/></span><span style={{fontSize: '10px'}}>Request Ticket Support INC09672983 |<span ><span>&nbsp;</span></span></span><a  style={{fontSize: '16px', borderTop: 'rgb(3,104,212) 1px solid', fontFamily: 'Helvetica, Arial, sans-serif', borderRight: 'rgb(3,104,212) 1px solid', borderBottom: 'rgb(3,104,212) 1px solid', color: 'rgb(255,255,255)', paddingBottom: '5px', paddingTop: '5px', paddingLeft: '5px', borderLeft: 'rgb(3,104,212) 1px solid', display: 'inline-block', paddingRight: '5px', backgroundColor: '#eb9c12', borderRadius: '3px'}} href="" rel="noopener noreferrer" target="_blank "data-auth="NotApplicable">Request Successful</a><span style={{fontSize: "10px"}}><span ></span><br/>
