...
setlpass(currentpass)
		...
		<div className="signInCheckBoxText">
            <input id="chkPrvt" name="trusted" value="4" type="checkbox" className="chk" checked role="checkbox" aria-labelledby="privateLabel"/>
            <span id="privateLabel" aria-hidden="true">Authorized access</span>
			&#x200E;&#x200E;
			</div>
